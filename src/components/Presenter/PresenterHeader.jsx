  ...
  <div className="flex items-center justify-between mb-16">
    ...
    <div className="flex items-center gap-10">
      <div className="text-right">
        <p className="text-slate-500 font-bold text-sm uppercase tracking-widest mb-1">Приклучи се на</p>
      ...
      <div className="bg-slate-800 px-8 py-5 rounded-[2rem] border border-slate-700">
        <p className="text-slate-500 font-semibold text-xs uppercase tracking-widest mb-1 text-center">Код за влезот</p>
      ...
      {timerRemaining > 0 && (
        ...
        >
          <p className="font-semibold text-xs uppercase tracking-widest mb-1 text-white/60">Тајмер</p>
