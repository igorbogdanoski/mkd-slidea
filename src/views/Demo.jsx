...
export default function Demo() {
  useSEO({
    title: 'Demo | MKD Slidea — Пробај интерактивни презентации без регистрација',
    description: 'Истражи го MKD Slidea без регистрација. Создавај и води интерактивни активности веднаш — анкети, квизови, word cloud, Q&A.',
    keywords: 'demo, проба, без регистрација, slidea demo',
    path: '/demo',
  });
