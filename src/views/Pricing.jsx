...
const FAQS = [
  ...
  {
    q: 'Како се плаќа?',
    a: 'Со банкарски трансфер — во евра (IBAN/SWIFT) или во денари на трансакциска сметка. По изборот на план добивате инструкции со број на нарачка што се впишува како цел на дознака. Планот се активира по потврда на уплатата, најдоцна во рок од 24 часа. За правни лица издаваме фактура со ЕДБ. Картичното плаќање сè уште не е достапно: Stripe не работи во Северна Македонија, а PayPal тука поддржува само испраќање, не и примање средства.',
  },
  {
