...
const FAQS = [
  ...
  },
  {
    ...
    // 40 seats is sized from a real school: 60 staff, of whom roughly half
    // would use the tool with their classes. Seats count active accounts, not
    // people on the payroll, so a 60-teacher school fits comfortably.
    a: 'Годишен план за правно лице со до 40 наставнички сметки, секоја со сите можности од планот Наставник. Вклучува заедничка библиотека со шаблони, фактура со ЕДБ, приоритетна поддршка и воведна обука за колективот. Местата се бројат како активни сметки, не како вработени — типично училиште со 60 вработени комотно се вклопува. За поголеми колективи и мрежи училишта, договараме посебно.',
  },
  {
    q: 'Колку чини по наставник во училишен план?',
  ...
  {
    q: 'Како се плаќа?',
    a: 'Со PayPal или банкарски трансфер — во евра (IBAN/SWIFT) или во денари на трансакциска сметка. По изборот на план добивате инструкции со број на нарачка што се впишува како цел на дознака, односно како порака кон уплатата. Планот се активира по потврда на уплатата, најдоцна во рок од 24 часа. За правни лица (училишта, организации) издаваме фактура со ЕДБ — тоа е и начинот на кој јавните установи плаќаат, бидејќи средствата им се во Трезор. Директно картично плаќање сè уште не е достапно: Stripe не работи во Северна Македонија.',
  },
  {
...
const Pricing = ({ setView }) => {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        "До 40 наставнички сметки",
        "Сè од планот Наставник за секој",
