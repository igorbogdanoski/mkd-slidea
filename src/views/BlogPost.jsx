...
export default function BlogPost() {
  ...
  useSEO(post ? {
    ...
    path: `/blog/${post.slug}`,
    image: `https://slidea.mismath.net/api/og-png?type=template&title=${encodeURIComponent(post.title)}&subject=${encodeURIComponent(post.subject)}`,
    jsonLd: {
      ...
      'publisher': {
        ...
        'name': 'MKD Slidea',
        'url': 'https://slidea.mismath.net/',
        'logo': { '@type': 'ImageObject', 'url': 'https://slidea.mismath.net/api/og-png' },
      },
      'image': `https://slidea.mismath.net/api/og-png?type=template&title=${encodeURIComponent(post?.title || '')}&subject=${encodeURIComponent(post?.subject || '')}`,
