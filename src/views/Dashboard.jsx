        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
              <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 flex flex-col">
                ...
                <div className="mt-auto flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={() => openExternal('/ppt-addin/manifest.xml')}
                    className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-indigo-600 text-white font-black hover:bg-indigo-700 transition-all"
                  >
                    <Download size={16} /> Преземи manifest
                  </button>
                  <button
                    onClick={() => openExternal('/integrations/index.html#microsoft')}
                    className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-slate-100 text-slate-700 font-black hover:bg-slate-200 transition-all"
                  >
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 flex flex-col">
                ...
                <div className="mt-auto grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <button
                    onClick={() => openExternal('/google-slides-addon/Code.gs')}
                    className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-emerald-600 text-white font-black hover:bg-emerald-700 transition-all"
                  >
                    <Download size={16} /> Code.gs
                  </button>
                  <button
                    onClick={() => openExternal('/google-slides-addon/Sidebar.html')}
                    className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-emerald-50 text-emerald-700 font-black hover:bg-emerald-100 transition-all"
                  >
                    <Download size={16} /> Sidebar.html
                  </button>
                  <button
                    onClick={() => openExternal('/integrations/index.html#google')}
                    className="sm:col-span-2 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-slate-100 text-slate-700 font-black hover:bg-slate-200 transition-all"
                  >
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 flex flex-col">
                ...
                <div className="mt-auto flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-amber-500 text-white font-black hover:bg-amber-600 transition-all"
                  >
                    <FileSpreadsheet size={16} /> Отвори Host
                  </button>
                  <button
                    onClick={() => openExternal('/integrations/index.html#ednevnik')}
                    className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-slate-100 text-slate-700 font-black hover:bg-slate-200 transition-all"
                  >
            ...
            <div className="mt-10 bg-slate-900 rounded-[2.5rem] p-8 text-white flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              ...
              <button
                onClick={() => openExternal('/integrations/index.html#publishing')}
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-white text-slate-900 font-black hover:bg-slate-100 transition-all"
              >
