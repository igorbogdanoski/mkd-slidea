...
8. ⬜ **Поставки по активност** — Timer и скриј резултати на ниво на секоја активност
...
**#3 Квиз feedback** — анимација correct/wrong по одговор кај учесникот
**#4 Vote protection** — session ID во DB
**#6 Drag & drop** — реорганизација на активностите
